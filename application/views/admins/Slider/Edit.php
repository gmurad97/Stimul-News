...
$s_type = $slider_info->slider_type == "slider_news" ? TRUE : FALSE;//TRUE - SLIDER NEWS OR FALSE - SLIDER_CUSTOM
?>
...
<div class="card bg-edit border-edit bg-opacity-5">
    <div class="card-header border-edit fw-bold d-flex flex-row justify-content-between align-items-center">
        ...
        <div>
            ...
            <?php if ($slider_info->slider_type == "slider_custom") : ?>
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs nav-tabs-v2 ps-4 pe-4">
            <li class="nav-item me-3"><a href="#slider_custom" class="nav-link <?= $slider_info->slider_type == 'slider_custom' ? 'active' : ''; ?>" data-bs-toggle="tab">Custom Form</a></li>
            <li class="nav-item me-3"><a href="#slider_news" class="nav-link <?= $slider_info->slider_type == 'slider_news' ? 'active' : ''; ?>" data-bs-toggle="tab">News Form</a></li>
        </ul>
        <div class="tab-content p-4">
            <div class="tab-pane fade <?= $slider_info->slider_type == 'slider_custom' ? 'show active' : ''; ?>" id="slider_custom">
            ...
            <div class="tab-pane fade <?= $slider_info->slider_type == 'slider_news' ? 'show active' : ''; ?>" id="slider_news">
                <?php //if($slider_info->slider_type == "slider_news"): 
                ?>
