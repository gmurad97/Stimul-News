...
<div class="card bg-list border-list bg-opacity-5">
    <div class="card-header border-list fw-bold d-flex flex-row justify-content-between align-items-center">
        ...
        <div>
            <a href="<?= base_url('admin/subscribers-create'); ?>" class="btn btn-success btn-sm rounded-2">
    ...
    <div class="card-body">
        ...
        <?php endif; ?>
        <table class="table table-hover text-nowrap w-100" id="subscribers-datatable">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Email</th>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content rounded">
            <div class="modal-body py-3">
                <p class="h5 text-danger">Do you really want to remove the subscriber?</p>
            </div>
