...
<div class="card">
    ...
    <div class="card-body">
        ...
        ?>
        <form action="<?= base_url('admin/news-edit-action/') . $news_id; ?>" method="POST" enctype="multipart/form-data" class="was-validated" id="news_form">
            <ul class="list-group list-group-flush mb-3">
                ...
                <div class="tab-content p-4">
                    <div class="tab-pane active" id="news_menu_en">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                ...
                                <input required name="news_title_en" type="text" class="form-control form-control-sm my-2" id="news_title_en_label" maxlength="50" value="<?= $news_info->news_title->en; ?>" placeholder="News Title">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <label for="news_short_description_en_label">Short Description</label>
                                <input required name="news_short_description_en" type="text" class="form-control form-control-sm my-2" id="news_short_description_en_label" maxlength="120" value="<?= $news_info->news_short->en; ?>" placeholder="Short Description">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="tab-pane" id="news_menu_ru">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <label for="news_title_ru_label" class="d-flex flex-row justify-content-start align-items-center">
                                    Title
                                    <span class="badge bg-dark ms-1">Max Length - 50</span>
                                </label>
                                <input required name="news_title_ru" type="text" class="form-control form-control-sm my-2" id="news_title_ru_label" maxlength="50" value="<?= $news_info->news_title->ru; ?>" placeholder="News Title">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <label for="news_short_description_ru_label">
                                    Short Description
                                    <span class="badge bg-dark ms-1">Max Length - 120</span>
                                </label>
                                <input required name="news_short_description_ru" type="text" class="form-control form-control-sm my-2" id="news_short_description_ru_label" maxlength="120" value="<?= $news_info->news_short->ru; ?>" placeholder="Short Description">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="tab-pane" id="news_menu_az">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <label for="news_title_az_label" class="d-flex flex-row justify-content-start align-items-center">
                                    Title
                                    <span class="badge bg-dark ms-1">Max Length - 50</span>
                                </label>
                                <input required name="news_title_az" type="text" class="form-control form-control-sm my-2" id="news_title_az_label" maxlength="50" value="<?= $news_info->news_title->az; ?>" placeholder="News Title">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <label for="news_short_description_az_label">
                                    Short Description
                                    <span class="badge bg-dark ms-1">Max Length - 120</span>
                                </label>
                                <input required name="news_short_description_az" type="text" class="form-control form-control-sm my-2" id="news_short_description_az_label" maxlength="120" value="<?= $news_info->news_short->az; ?>" placeholder="Short Description">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
