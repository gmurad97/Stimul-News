...
<script src="<?= base_url('public/user/assets/js/waypoints.min.js'); ?>"></script>
<script src="<?= base_url('public/user/assets/js/imagesloaded.pkgd.min.js'); ?>"></script>
<script src="<?= base_url('public/user/assets/js/isotope.min.js'); ?>"></script>
